...
export default function LeadsList() {
  ...
  return (
    <>
      ...
      <form className="mb-6 flex flex-wrap items-end gap-3 [&_input]:min-w-[220px] [&_label]:grid [&_label]:gap-1.5" onSubmit={(e) => { e.preventDefault(); setPage(1); setSearch(draft.trim()); }}>
