...
describe('rental authorization',()=>{
  it('does not mount rental data loaders for AGENT',()=>{
    vi.mocked(useAuth).mockReturnValue({agent:{id:'a',name:'Agent',role:'AGENT',email:'a@example.test',active:true,avatarUrl:null,creci:null,whatsappNumber:'5565999999999',createdAt:''},loading:false,login:vi.fn(),logout:vi.fn(),refresh:vi.fn()});
