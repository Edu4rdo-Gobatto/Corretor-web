  ...
  return <>
    ...
    {pessoa && !erro && <>
      ...
      <section className={estilos.painel}>
        ...
        <dl className="m-0 grid gap-3.5 md:grid-cols-2 [&_dd]:m-0 [&_dd]:[overflow-wrap:anywhere] [&_dt]:text-[13px] [&_dt]:uppercase [&_dt]:tracking-[0.08em] [&_dt]:text-muted">
      ...
      {vinculos.dados && <div className="grid gap-6 lg:grid-cols-3">
      ...
      {confirmando && <Dialogo titulo={pessoa.ativo ? 'Desativar cadastro' : 'Reativar cadastro'} aoFechar={() => { if (!ocupado) setConfirmando(false); }}>
